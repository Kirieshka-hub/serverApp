...
"border-bottom-right-radius:180px;")
        ...
        self.pushButton_4.setStyleSheet("QPushButton { color: #fff; font-size: 24px; padding: 10px 45px; border: 1px solid transparent; border-radius: 8px; font-weight: 600; letter-spacing: 0.5px; text-transform: uppercase; margin-top: 10px; cursor: pointer; background-color: transparent; border-color: #fff; transition: background-color 0.5s ease; } QPushButton:hover { background-color: rgba(255, 255, 255, 0.8); }")
...
"")
        ...
        self.textEdit.setStyleSheet("QTextEdit { background-color: rgba(255, 255, 255, .1); /* Цвет фона */ backdrop-filter: blur(10px); color: black; /* Цвет текста */ font-size: 24px; /* Размер шрифта */ padding: 10px; /* Отступы внутри редактора */ border: 1px solid #ccc; /* Граница */ border-radius: 5px; /* Скругление углов */ } QTextEdit:focus { border: 1px solid #512da8; /* Цвет границы при фокусе */ } QTextEdit QScrollBar { background: #e0e0e0; /* Цвет фона полосы прокрутки */ width: 10px; /* Ширина полосы прокрутки */ } QTextEdit QScrollBar::handle { background: #512da8; /* Цвет ручки полосы прокрутки */ border-radius: 5px; /* Скругление углов ручки */ } QTextEdit QScrollBar::handle:hover { background: #7b1fa2; /* Цвет ручки при наведении */ } QTextEdit QScrollBar::add-line, QTextEdit QScrollBar::sub-line { background: none; /* Убираем фон для кнопок прокрутки */ }\n"
"")
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Register with your personal details to use all of site feautures"))
        ...
        self.label_6.setText(_translate("MainWindow", "Register with your personal details to use all of site feautures"))
